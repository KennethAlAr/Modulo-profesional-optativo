...
#     print(f"{Back.WHITE}┌─────────────┐{Style.RESET_ALL}")
#     print(f"{Back.WHITE}│{Style.BRIGHT}{weather_code_icons.get(i)[0]}{Style.RESET_ALL}{Back.WHITE}│{Style.RESET_ALL}")
#     print(f"{Back.WHITE}│{Style.BRIGHT}{weather_code_icons.get(i)[1]}{Style.RESET_ALL}{Back.WHITE}│{Style.RESET_ALL}")
#     print(f"{Back.WHITE}│{Style.BRIGHT}{weather_code_icons.get(i)[2]}{Style.RESET_ALL}{Back.WHITE}│{Style.RESET_ALL}")
#     print(f"{Back.WHITE}│{Style.BRIGHT}{weather_code_icons.get(i)[3]}{Style.RESET_ALL}{Back.WHITE}│{Style.RESET_ALL}")
#     print(f"{Back.WHITE}└─────────────┘{Style.RESET_ALL}")